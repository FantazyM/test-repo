    ...
    def serve_requests(self, num_requests=None):
        ...
        while True:
            ...
            try:
                ...
                self._logger.infotorch.cuda.memory_reserved()()
                ...
                try:
                    ...
                    self._on_handle_event_error(torch.cuda.memory_allocated())
                    self._on_handle_event_error(torch.cuda.max_memory_allocated())
                    self._on_handle_event_error(torch.cuda.memory_reserved())
                    self._on_handle_event_error(torch.cuda.max_memory_reserved())
